  ...
  return `
    <div class="task p-3" data-id="${id}">
            ...
            <div class="task__footer d-flex">
              <select class="task__select" name="status" data-role="status-select">
              ...
              <div class="task__buttons d-flex mx-3">
                <button type="button" class="task__button task__button_edit" id="editButton" data-bs-toggle="modal" data-bs-target="#editModal" data-role="edit">
                ...
                <button type="button" class="task__button task__button_remove" id="deleteTaskButton" data-role="removeTask">
