...
const buildTaskTemplate = ({ id, title, createdAt, description, executiveUser, status }) => {
  ...
  return `
    <div class="task p-3 my-2 border border-secondary rounded-3 gap-1" data-id="${id}">
      ...
      <div class="d-flex flex-column gap-2">
        <select class="form-select user__select opacity-75 w-100" name="users" required>
          ${userSelectTemplate(usersList, executiveUser)}
        </select>
        <select class="form-select task__select opacity-75 w-100" name="status"
        ...
        <div class="task__buttons mt-3 d-flex gap-3 justify-content-end">
          <button type="button" class="btn border-dark-subtle task__button rounded-3 regular-btn"
          id="editButton" data-bs-toggle="modal" data-bs-target="#editModal" data-role="edit">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-pencil-square pe-none" viewBox="0 0 16 16">
              <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
              <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
            </svg>
          </button>
          <button type="button" class="btn border-dark-subtle task__button rounded-3 delete-btn"
          data-bs-toggle="modal" data-bs-target="#deleteModal"
            id="deleteTaskButton" data-role="removeTask">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-trash3 pe-none" viewBox="0 0 16 16">
