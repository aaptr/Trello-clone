  ...
  return `
    <div class="task p-3 my-2 border border-secondary rounded-3 gap-1" data-id="${id}">
            ...
            <div class="d-flex flex-column gap-2">
              ...
              <select class="form-select task__select opacity-75 w-100" name="status" data-role="status-select">
              ...
              <div class="task__buttons mt-3 d-flex gap-3">
                ...
                <button type="button" class="btn border-dark-subtle task__button rounded-3 delete-btn" data-bs-toggle="modal" data-bs-target="#deleteModal"
